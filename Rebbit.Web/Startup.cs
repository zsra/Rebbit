...
using Rebbit.Web;
using Rebbit.Web.Configurations;
using System;
...
namespace Rebbit
{
    public class Startup
    {
        ...
        {
            // use in-memory database
            services.AddDbContext<RebbitDbContext>(c =>
                c.UseInMemoryDatabase("Rebbit"));
        ...
        public void ConfigureProductionServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<RebbitDbContext>(c =>
                c.UseSqlServer(Configuration.GetConnectionString("RebbitConnection")));
        ...
        {
            var catalogBaseUrl = Configuration.GetValue(typeof(string), "RebbitBaseUrl") as string;
